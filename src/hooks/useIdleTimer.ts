 ...
 * minutes without touching the glass used to reset Friends Kitchen mid-sentence and
 * empty the basket.
 */
...
/** Fires onIdle after `timeout` ms of no touch/pointer activity. Friends Kitchen reset. */
